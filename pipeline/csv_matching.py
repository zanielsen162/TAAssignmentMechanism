...
from loading_data_ilp import format_dfs
...
if __name__ == "__main__":
    ...
    courses_file = 'testing-data/test1c.csv'
    applicants_file = 'testing-data/test1a.csv'
    rankings_file = 'testing-data/test1r.csv'
